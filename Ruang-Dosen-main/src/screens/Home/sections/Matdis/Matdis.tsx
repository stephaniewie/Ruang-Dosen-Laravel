...
const Matdis = () => {
  ...
  return (
    ...
    <Card
        ...
        style={{
        background: `linear-gradient(180deg, rgba(0,0,0,0) 0%, rgba(0,0,0,0.5) 84%), url('https://c.animaapp.com/mbpscubqJ4b9Pt/img/frame-2087327359.png') center center no-repeat`,
        backgroundSize: 'cover',
        }}
    >
        <h1 className="text-3xl font-medium text-white">Matematika Diskrit</h1>
    </Card>
    </div>
